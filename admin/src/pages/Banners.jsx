    ...
    <div className="flex justify-evenly m-[10%]">
       ...
       <div className="mr-[50px]">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 pb-4" key={index}>
            ...
            <button className="bg-red-500 p-2 text-white font-semibold cursor-pointer" onChange={() => handleDelete(banner._id)}>Delete</button>
        ...
        <div className="flex flex-col ">
          <div className="flex-1 bg-white p-5">
            ...
            <div className="flex flex-col">
              ...
              (
                <img src={URL.createObjectURL(selectedImage)} alt="" className="h-[100px] w-[100px] object-cover rounded-md border"  />
              )
